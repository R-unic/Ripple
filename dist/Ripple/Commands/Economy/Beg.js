...
class default_1 extends discord_akairo_1.Command {
    ...
    exec(msg) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const queue = yield this.client.TimeQueue.Find(msg.member, "beg");
            ...
            const amount = (0, Util_1.RandomInt)(300);
            return this.client.Bank.Increment(msg.member, amount)
                .then(s => {
                if (s) {
                    this.client.TimeQueue.Add(msg.member, new TimeQueue_1.TimeQueue("beg", (0, ms_1.default)("1h")));
                    return msg.reply(this.client.Embed("Panhandling", "💰")
                        .setDescription("You begged for a total of $" + (0, Util_1.CommaNumber)(amount) + "."));
                }
            });
        });
    }
