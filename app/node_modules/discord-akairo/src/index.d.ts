declare module 'discord-akairo' {
    ...
    export class Command<ClientT extends AkairoClient = AkairoClient> extends AkairoModule {
        public constructor(id: string, options?: CommandOptions);

        public aliases: string[];
        public argumentDefaults: DefaultArgumentOptions;
        public quoted: boolean;
        public category: Category<string, Command<ClientT>>;
        ...
        public filepath: string;
        public handler: CommandHandler<ClientT>;
        public id: string;
    ...
    export class CommandHandler<ClientT extends AkairoClient = AkairoClient> extends AkairoHandler {
        public constructor(client: ClientT, options: CommandHandlerOptions);
        ...
        public categories: Collection<string, Category<string, Command<ClientT>>>;
        ...
        public useInhibitorHandler(inhibitorHandler: InhibitorHandler<ClientT>): this;
        ...
        public on(event: 'commandBlocked', listener: (message: Message, command: Command<ClientT>, reason: string) => any): this;
        ...
        public on(event: 'cooldown', listener: (message: Message, command: Command<ClientT>, remaining: number) => any): this;
    ...
    export class Inhibitor<ClientT extends AkairoClient = AkairoClient> extends AkairoModule {
        public constructor(id: string, options?: InhibitorOptions);

        public category: Category<string, Inhibitor<ClientT>>;
        public client: ClientT;
        public filepath: string;
        public handler: InhibitorHandler<ClientT>;
        public id: string;
        public reason: string;
        public type: string;

        public exec(message: Message, command?: Command<ClientT>): boolean | Promise<boolean>;
        public reload(): this;
        public remove(): this;
    }

    export class InhibitorHandler<ClientT extends AkairoClient = AkairoClient> extends AkairoHandler {
        public constructor(client: ClientT, options: AkairoHandlerOptions);

        public categories: Collection<string, Category<string, Inhibitor<ClientT>>>;
        public classToHandle: typeof Inhibitor;
        public client: ClientT;
        public directory: string;
        public modules: Collection<string, Inhibitor<ClientT>>;

        public deregister(inhibitor: Inhibitor<ClientT>): void;
        public findCategory(name: string): Category<string, Inhibitor<ClientT>>;
        public load(thing: string | Function): Inhibitor<ClientT>;
        public loadAll(directory?: string, filter?: LoadPredicate): this;
        public register(inhibitor: Inhibitor<ClientT>, filepath?: string): void;
        public reload(id: string): Inhibitor<ClientT>;
        public reloadAll(): this;
        public remove(id: string): Inhibitor<ClientT>;
        public removeAll(): this;
        public test(type: 'all' | 'pre' | 'post', message: Message, command?: Command<ClientT>): Promise<string | void>;
        public on(event: 'remove', listener: (inhibitor: Inhibitor<ClientT>) => any): this;
        public on(event: 'load', listener: (inhibitor: Inhibitor<ClientT>, isReload: boolean) => any): this;
    }
